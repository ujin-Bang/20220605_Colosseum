...
//    언제 적힌 댓글?
    var createdAt = Calendar.getInstance() //기본 Calendar 대입 -> 현재일시가 저장됨.
...
//        ex. 서울 -> +9 -=> 게시글 작성시간도 9시간 더해서 보여줘야함.

//     내 핸드폰에 설정된 시간대가 어느 시간대인가? =>ex.서울
...
//            임시로 추출한 (String -> Calendar)형태로 변환 -> 댓글데이터의 작성일시로 반영.

//            서버가 준 String을 분석하기 위한 SimpleDateFormat 만들기
            val sdf = SimpleDateFormat("yyyy-MM-dd HH:mm:ss")

//            parse로 Date형태의 일시 생성 -> Calendar변수.time에 대입.
